...
import static pl.przemekzagorski.training.patterns.PatternExercisesSolutions.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * ╔═══════════════════════════════════════════════════════════════════╗
 * ║         TESTY - WZORCE PROJEKTOWE (SOLUTIONS)                    ║
 * ╠═══════════════════════════════════════════════════════════════════╣
 * ║  Testujemy rozwiązania ćwiczeń (AppConfig, WeaponFactory, etc.)  ║
 * ║  TEN PLIK JEST DLA TRENERA - NIE COMMITUJ DO REPO!               ║
 * ╚═══════════════════════════════════════════════════════════════════╝
 */
@DisplayName("Design Patterns Solutions Tests")
class PatternSolutionsTest {
